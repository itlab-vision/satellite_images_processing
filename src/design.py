...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.preview = QtWidgets.QPushButton(self.groupBox_properties)
        self.preview.setObjectName("preview")
        self.horizontalLayout_2.addWidget(self.preview)
        self.date = QtWidgets.QPushButton(self.groupBox_properties)
        self.date.setObjectName("date")
        self.horizontalLayout_2.addWidget(self.date)
        self.clear = QtWidgets.QPushButton(self.groupBox_properties)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.preview.setText(_translate("MainWindow", "Preview mode"))
        self.date.setText(_translate("MainWindow", "Choose a date"))
        self.clear.setText(_translate("MainWindow", "Clear markers"))
