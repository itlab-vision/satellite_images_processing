...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.button_preview = QtWidgets.QPushButton(self.groupBox_properties)
        self.button_preview.setObjectName("button_preview")
        self.horizontalLayout_2.addWidget(self.button_preview)
        self.button_date = QtWidgets.QPushButton(self.groupBox_properties)
        self.button_date.setObjectName("button_date")
        self.horizontalLayout_2.addWidget(self.button_date)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.button_preview.setText(_translate("MainWindow", "Preview mode"))
        self.button_date.setText(_translate("MainWindow", "Choose a date"))
        self.button_clear.setText(_translate("MainWindow", "Clear markers"))
